...
public class Database extends SQLiteOpenHelper {
    ...
    public int login(String username, String password){
        ...
        c.close(); // Mbyll Cursor për të shmangur rrjedhje të burimeve
        db.close(); // Mbyll SQLiteDatabase për të shmangur rrjedhje të burimeve
        return result;
    ...
    public int checkCart(String username, String product){
        ...
        Log.d("Database", "Cart add: " + result);
        c.close(); // Mbyll Cursor për të shmangur rrjedhje të burimeve
        db.close(); // Mbyll SQLiteDatabase për të shmangur rrjedhje të burimeve
        return result;

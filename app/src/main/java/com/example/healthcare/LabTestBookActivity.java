...
public class LabTestBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edname = findViewById(R.id.editTextTextTBFullName);
        edaddress = findViewById(R.id.editTextTextTBAddress);
        edcontact = findViewById(R.id.editTextTextTBcontact);
        edpincode = findViewById(R.id.editTextTextTBcode);
